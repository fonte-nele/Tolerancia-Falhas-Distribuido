...
public class Servidor2 {
	...
	public static void main(String[] args) throws Exception {
		...
		Globals.outroServidor = "200.239.138.122";
			...
			try {
				if (serverPrincipal) {
					...
					if (filaAlteracoes.size() > 0) {
						...
						System.out.println("realizando alteraçao vinda do ip: " + alteracao.getFrom());
						...
						System.out.println("\t" + alteracao.getQuantidade() + " alteraçoes enviadas para os "
			...
			try {
				...
				try {
					...
					if (message.getType() == Globals.CHANGE) {
						...
						System.out.println("RECEBENDO ATUALIZAÇOES");
